...
def load_models():
    ...
    key_dict = {
        "hindi":["hi","hin_Deva",hin_text_speech_model,hin_text_speech_tokenizer],
        "kannada":["kn","kan_Knda",kan_text_speech_model,kan_text_speech_tokenizer],
        "tamil":["ta","tam_Taml",tam_text_speech_model,tam_text_speech_tokenizer],
        "telugu":["te","tel_Telu",tel_text_speech_model,tel_text_speech_tokenizer] }
...
def record(person):
    ...
    if person1 and person2:
        if person == "person1":
            ...
            lang_src, lang_tgt = person1[1], person2[1]
            tts_model, tts_tokenizer = person2[2],person2[3]
        else:
            speech_scr = person2[0]
            lang_src, lang_tgt = person2[1], person1[1]
        ...
        input_text,output_text = text_translation(text=text,src_lang=lang_src,dest_lang=lang_tgt)
